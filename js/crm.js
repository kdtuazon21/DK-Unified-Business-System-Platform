...
const CRM = {
        ...
        return Utils.buildTable(
            ...
            customers,
            {
                actions: (c) => `
                    ...
                    <button class="btn btn-sm btn-secondary" onclick="CRM.editCustomer('${c.id}')" title="Edit" style="margin-left:4px"><i class="fas fa-edit"></i></button>
                `
            }
        );
    },
    ...
    editCustomer(id) {
        App.showToast('Edit form would open here (demo)', 'info');
    }
};
